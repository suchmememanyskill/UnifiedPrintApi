...
public class PrintablesApi : IApiDescription
{
    ...
    private string SearchTemplate => new ("{\"operationName\":\"SearchPrints\",\"variables\":{\"query\":\"{{QUERY}}\",\"categoryId\":null,\"featured\":false,\"hasMake\":false,\"competitionAwarded\":false,\"ordering\":null,\"limit\":{{LIMIT}},\"offset\":{{OFFSET}}},\"query\":\"query SearchPrints($query: String, $limit: Int, $offset: Int, $categoryId: ID, $materialIds: [Int], $printerIds: [Int], $featured: Boolean, $printDuration: IntervalObject, $weight: IntervalObject, $nozzleDiameters: [Float], $filesType: [FilterPrintFilesTypeEnum], $usedMaterial: IntervalObject, $licenses: [ID], $hasMake: Boolean, $publishedDateLimitDays: Int, $competitionAwarded: Boolean, $exclusiveFromClubs: Boolean, $paid: PaidEnum, $downloadable: Boolean, $price: IntervalObject, $ordering: SearchChoicesEnum) {\\n  result: searchPrints(\\n    query: $query\\n    printType: print\\n    limit: $limit\\n    offset: $offset\\n    categoryId: $categoryId\\n    materialIds: $materialIds\\n    printerIds: $printerIds\\n    featured: $featured\\n    printDuration: $printDuration\\n    weight: $weight\\n    nozzleDiameters: $nozzleDiameters\\n    filesType: $filesType\\n    usedMaterial: $usedMaterial\\n    licenses: $licenses\\n    hasMake: $hasMake\\n    publishedDateLimitDays: $publishedDateLimitDays\\n    competitionAwarded: $competitionAwarded\\n    exclusiveFromClubs: $exclusiveFromClubs\\n    downloadablePremium: $downloadable\\n    paid: $paid\\n    price: $price\\n    ordering: $ordering\\n  ) {\\n    items {\\n      ...SearchPrintsFragment\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment SearchPrintsFragment on SearchPrintType {\\n  id\\n  eduProject {\\n    language {\\n      id\\n      name\\n      __typename\\n    }\\n    __typename\\n  }\\n  image {\\n    filePath\\n    rotation\\n    __typename\\n  }\\n  ratingAvg\\n  ratingCount\\n  filesType\\n  hasModel\\n  nsfw\\n  premium\\n  price\\n  name\\n  ...LatestCompetitionResultSearch\\n  downloadCount\\n  displayCount\\n  dateFeatured\\n  datePublished\\n  slug\\n  liked\\n  likesCount\\n  user {\\n    ...AvatarSearchFragment\\n    __typename\\n  }\\n  __typename\\n}\\n\\nfragment LatestCompetitionResultSearch on SearchPrintType {\\n  latestCompetitionResult {\\n    placement\\n    competitionId\\n    __typename\\n  }\\n  __typename\\n}\\n\\nfragment AvatarSearchFragment on SearchUserType {\\n  id\\n  publicUsername\\n  company\\n  verified\\n  handle\\n  avatarFilePath\\n  badgesProfileLevel {\\n    profileLevel\\n    __typename\\n  }\\n  __typename\\n}\"}");
